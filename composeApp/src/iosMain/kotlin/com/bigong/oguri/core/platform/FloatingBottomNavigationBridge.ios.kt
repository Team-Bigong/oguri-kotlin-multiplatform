...
private const val FLOATING_BOTTOM_NAVIGATION_STATE_CHANGED_NOTIFICATION_NAME =
    "OguriFloatingBottomNavigationStateChanged"
...
private const val KEY_BACKGROUND_COLOR_ARGB = "backgroundColorArgb"
...
private const val FLOATING_BOTTOM_NAVIGATION_MINIMUM_IOS_MAJOR_VERSION = 26L

actual fun isFloatingBottomNavigationEnabled(): Boolean {
    ...
    return majorVersion >= FLOATING_BOTTOM_NAVIGATION_MINIMUM_IOS_MAJOR_VERSION
}
...
actual fun notifyFloatingBottomNavigationState(
    ...
    val userInfo: Map<Any?, Any?> =
        mapOf<Any?, Any?>(
            ...
            KEY_BACKGROUND_COLOR_ARGB to backgroundColorArgb.toString(),
    ...
    NSNotificationCenter.defaultCenter.postNotificationName(
        aName = FLOATING_BOTTOM_NAVIGATION_STATE_CHANGED_NOTIFICATION_NAME,
        `object` = null,
        userInfo = userInfo,
    )
}
