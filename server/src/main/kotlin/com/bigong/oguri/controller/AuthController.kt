...
class AuthController(
    ...
    @Operation(summary = "카카오 로그인", description = "카카오 액세스 토큰으로 로그인을 시도하고 서비스 전용 토큰을 발급합니다. 응답의 onboardingCompleted가 false면 온보딩 화면으로 이동해야 합니다. Authorization 헤더 없이 호출합니다.")
    ...
    @Operation(summary = "애플 로그인", description = "Apple identityToken으로 로그인을 시도하고 서비스 전용 토큰을 발급합니다. 응답의 onboardingCompleted가 false면 온보딩 화면으로 이동해야 합니다. Authorization 헤더 없이 호출합니다.")
